...
ROOT_URLCONF = 'finecode.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "finecode", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'finecode.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'classroom')
...
LOGOUT_REDIRECT_URL = 'landingpage:index'
